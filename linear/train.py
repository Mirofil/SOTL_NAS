...
# python linear/train.py --cfg=linear/configs/lr/mnist_mlp.py --alpha_lr_reject_strategy=zero --T=1 --train_arch=False --w_lr=0.001 --w_optim=Adam --alpha_lr=None --mode=joint
