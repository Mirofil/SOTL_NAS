...
# python linear/train.py --cfg=linear/configs/lr/mnist_mlp.py --alpha_lr_reject_strategy=half --T=50 --train_arch=True --w_lr=0.01 --w_momentum=0.9 --w_optim=HyperSGD --alpha_lr=0.01 --mode=bilevel --model_type=MLP2 --a_lr=0.03

# python linear/train.py --cfg=linear/configs/lr/mnist_vgg.py --T=4 --w_momentum=0.9 --w_optim=HyperSGD 
