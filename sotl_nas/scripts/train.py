...
# python sotl_nas/scripts/train.py --model_type=max_deg --epochs 1 --steps_per_epoch=None --dataset=fourier --dry_run=True --grad_outer_loop_order=-1 --grad_inner_loop_order=-1 --mode=bilevel --device=cpu --ihvp=exact --inv_hess=exact --hvp=exact --rand_seed 1 --arch_train_data sotl --optimizer_mode=autograd --T=3 --recurrent False --w_lr=1e-1 --a_lr=1e-3 --adaptive_a_lr=False --w_optim=HyperSGD
...
# python sotl_nas/scripts/train.py --cfg=sotl_nas/configs/lr/mnist_mlp.py --alpha_lr_reject_strategy=half --T=25 --train_arch=True --w_lr=0.01 --w_momentum=0.9 --w_optim=HyperSGD --alpha_lr=0.01--mode=bilevel --model_type=MLP2 --a_lr=0.01
